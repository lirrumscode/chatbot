...
const index$1 = require('./index-5c5a02bb.js');
const cubicBezier = require('./cubic-bezier-7fd071cd.js');
const theme = require('./theme-00f1b65e.js');
    ...
    componentDidLoad() {
        {
            rIC(() => {
                ...
                if (!ionicGlobal.config.getBoolean('_testing')) {
                    Promise.resolve().then(function () { return require('./tap-click-5f400d37.js'); }).then(module => module.startTapClick(ionicGlobal.config));
                }
                if (ionicGlobal.config.getBoolean('statusTap', isHybrid)) {
                    Promise.resolve().then(function () { return require('./status-tap-ab09d471.js'); }).then(module => module.startStatusTap());
                }
                if (ionicGlobal.config.getBoolean('inputShims', needInputShims())) {
                    Promise.resolve().then(function () { return require('./input-shims-8477cf76.js'); }).then(module => module.startInputShims(ionicGlobal.config));
                }
                if (ionicGlobal.config.getBoolean('hardwareBackButton', isHybrid)) {
                    Promise.resolve().then(function () { return require('./hardware-back-button-2b00490e.js'); }).then(module => module.startHardwareBackButton());
                }
                if (typeof window !== 'undefined') {
                    Promise.resolve().then(function () { return require('./keyboard-61951ffa.js'); }).then(module => module.startKeyboardAssist(window));
                }
                Promise.resolve().then(function () { return require('./focus-visible-2fe3eac8.js'); }).then(module => module.startFocusVisible());
            });
        }
    }
    render() {
...
class Content {
    ...
    render() {
        ...
        this.resize();
        return (index.h(index.Host, { class: Object.assign(Object.assign({}, theme.createColorClasses(this.color)), { [mode]: true, 'content-sizing': theme.hostContext('ion-popover', this.el), 'overscroll': forceOverscroll }), style: {
...
class RouterOutlet {
    ...
    async connectedCallback() {
        this.gesture = (await Promise.resolve().then(function () { return require('./swipe-back-99da0bcf.js'); })).createSwipeBackGesture(this.el, () => !!this.swipeHandler && this.swipeHandler.canStart() && this.animationEnabled, () => this.swipeHandler && this.swipeHandler.onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
            if (this.ani) {
    ...
    async transition(enteringEl, leavingEl, opts = {}) {
        ...
        await index$1.transition(Object.assign({ mode,
            animated,
            animationBuilder,
            enteringEl,
...
class Toolbar {
    ...
    render() {
        ...
        return (index.h(index.Host, { class: Object.assign(Object.assign({ 'in-toolbar': theme.hostContext('ion-toolbar', this.el), [mode]: true }, childStyles), theme.createColorClasses(this.color)) }, index.h("div", { class: "toolbar-background" }), index.h("div", { class: "toolbar-container" }, index.h("slot", { name: "start" }), index.h("slot", { name: "secondary" }), index.h("div", { class: "toolbar-content" }, index.h("slot", null)), index.h("slot", { name: "primary" }), index.h("slot", { name: "end" }))));
    }
    get el() { return index.getElement(this); }
}
Toolbar.style = {
