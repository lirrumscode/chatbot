...
var ActionSheet = /** @class */ (function () {
    ...
    ActionSheet.prototype.componentDidLoad = function () {
        ...
        readTask(function () {
            ...
            if (!isScrollable) {
                _this.gesture = createButtonActiveGesture(wrapperEl, function (refEl) { return refEl.classList.contains('action-sheet-button'); });
    ...
    ActionSheet.prototype.render = function () {
        ...
        return (h(Host, { role: "dialog", "aria-modal": "true", tabindex: "-1", style: {
            ...
            }, class: Object.assign(Object.assign((_a = {}, _a[mode] = true, _a), getClassMap(this.cssClass)), { 'action-sheet-translucent': this.translucent }), onIonActionSheetWillDismiss: this.dispatchCancelHandler, onIonBackdropTap: this.onBackdropTap }, h("ion-backdrop", { tappable: this.backdropDismiss }), h("div", { class: "action-sheet-wrapper", role: "dialog", ref: function (el) { return _this.wrapperEl = el; } }, h("div", { class: "action-sheet-container" }, h("div", { class: "action-sheet-group", ref: function (el) { return _this.groupEl = el; } }, this.header !== undefined &&
