...
require('./index-fdd5743d.js');
const index$3 = require('./index-28ba2a42.js');
require('./hardware-back-button-2b00490e.js');
const overlays = require('./overlays-658265f7.js');
require('./haptic-4965d822.js');
const buttonActive = require('./button-active-524d6f64.js');
...
class Alert {
    ...
    renderInput(labelledby) {
        ...
        return (index.h("div", { class: "alert-input-group", "aria-labelledby": labelledby }, inputs.map(i => {
            var _a, _b, _c, _d;
            if (i.type === 'textarea') {
                return (index.h("div", { class: "alert-input-wrapper" }, index.h("textarea", Object.assign({ placeholder: i.placeholder, value: i.value, id: i.id, tabIndex: 0 }, i.attributes, { disabled: (_b = (_a = i.attributes) === null || _a === void 0 ? void 0 : _a.disabled) !== null && _b !== void 0 ? _b : i.disabled, class: inputClass(i), onInput: e => {
                        var _a;
                ...
                return (index.h("div", { class: "alert-input-wrapper" }, index.h("input", Object.assign({ placeholder: i.placeholder, type: i.type, min: i.min, max: i.max, value: i.value, id: i.id, tabIndex: 0 }, i.attributes, { disabled: (_d = (_c = i.attributes) === null || _c === void 0 ? void 0 : _c.disabled) !== null && _d !== void 0 ? _d : i.disabled, class: inputClass(i), onInput: e => {
                        var _a;
                        i.value = e.target.value;
                        if ((_a = i.attributes) === null || _a === void 0 ? void 0 : _a.onInput) {
                            i.attributes.onInput(e);
    ...
    render() {
        ...
        return (index.h(index.Host, { role: "dialog", "aria-modal": "true", tabindex: "-1", style: {
            ...
            }, class: Object.assign(Object.assign({}, theme.getClassMap(this.cssClass)), { [mode]: true, 'alert-translucent': this.translucent }), onIonAlertWillDismiss: this.dispatchCancelHandler, onIonBackdropTap: this.onBackdropTap }, index.h("ion-backdrop", { tappable: this.backdropDismiss }), index.h("div", { class: "alert-wrapper", ref: el => this.wrapperEl = el }, index.h("div", { class: "alert-head" }, header && index.h("h2", { id: hdrId, class: "alert-title" }, header), subHeader && index.h("h2", { id: subHdrId, class: "alert-sub-title" }, subHeader)), index.h("div", { id: msgId, class: "alert-message", innerHTML: index$3.sanitizeDOMString(this.message) }), this.renderAlertInputs(labelledById), this.renderAlertButtons())));
    }
