...
import { r as registerInstance, h, H as Host, e as getElement, c as createEvent, d as readTask, f as forceUpdate, w as writeTask } from './index-29df6f59.js';
import { b as getIonMode, c as config, i as isPlatform } from './ionic-global-08f4fb8a.js';
import { c as clamp } from './helpers-5c745fbd.js';
import { t as transition } from './index-c5440634.js';
    ...
    App.prototype.componentDidLoad = function () {
        {
            rIC(function () {
                ...
                if (config.getBoolean('statusTap', isHybrid)) {
                    import('./status-tap-171795fe.js').then(function (module) { return module.startStatusTap(); });
                }
                if (config.getBoolean('inputShims', needInputShims())) {
                    import('./input-shims-d4609e0d.js').then(function (module) { return module.startInputShims(config); });
                }
                if (config.getBoolean('hardwareBackButton', isHybrid)) {
                    import('./hardware-back-button-7b6ede21.js').then(function (module) { return module.startHardwareBackButton(); });
                }
                if (typeof window !== 'undefined') {
                    import('./keyboard-a2b5e51d.js').then(function (module) { return module.startKeyboardAssist(window); });
                }
