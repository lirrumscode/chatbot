import { r as registerInstance, c as createEvent, f as forceUpdate, h, H as Host, e as getElement } from './index-29df6f59.js';
...
import { B as BACKDROP, i as isCancel, d as prepareOverlay, e as present, f as dismiss, g as eventMethod, s as safeCall } from './overlays-7369bfcc.js';
import './haptic-7b8ba70a.js';
import { c as createButtonActiveGesture } from './button-active-274abd17.js';
...
var Alert = /** @class */ (function () {
    ...
    Alert.prototype.componentDidLoad = function () {
        ...
        this.gesture = createButtonActiveGesture(this.wrapperEl, function (refEl) { return refEl.classList.contains('alert-button'); });
    ...
    Alert.prototype.rbClick = function (selectedInput) {
        for (var _i = 0, _e = this.processedInputs; _i < _e.length; _i++) {
            var input = _e[_i];
    ...
    Alert.prototype.renderRadio = function (labelledby) {
        ...
        return (h("div", { class: "alert-radio-group", role: "radiogroup", "aria-labelledby": labelledby, "aria-activedescendant": this.activeId }, inputs.map(function (i) { return (h("button", { type: "button", onClick: function () { return _this.rbClick(i); }, "aria-checked": "" + i.checked, disabled: i.disabled, id: i.id, tabIndex: 0, class: Object.assign(Object.assign({}, getClassMap(i.cssClass)), { 'alert-radio-button': true, 'alert-tappable': true, 'alert-radio': true, 'ion-focusable': true, 'alert-radio-button-disabled': i.disabled || false }), role: "radio" }, h("div", { class: "alert-button-inner" }, h("div", { class: "alert-radio-icon" }, h("div", { class: "alert-radio-inner" })), h("div", { class: "alert-radio-label" }, i.label)))); })));
    };
    Alert.prototype.renderInput = function (labelledby) {
        ...
        return (h("div", { class: "alert-input-group", "aria-labelledby": labelledby }, inputs.map(function (i) {
            var _a, _b, _c, _d;
            if (i.type === 'textarea') {
                return (h("div", { class: "alert-input-wrapper" }, h("textarea", Object.assign({ placeholder: i.placeholder, value: i.value, id: i.id, tabIndex: 0 }, i.attributes, { disabled: (_b = (_a = i.attributes) === null || _a === void 0 ? void 0 : _a.disabled) !== null && _b !== void 0 ? _b : i.disabled, class: inputClass(i), onInput: function (e) {
                        var _a;
                ...
                return (h("div", { class: "alert-input-wrapper" }, h("input", Object.assign({ placeholder: i.placeholder, type: i.type, min: i.min, max: i.max, value: i.value, id: i.id, tabIndex: 0 }, i.attributes, { disabled: (_d = (_c = i.attributes) === null || _c === void 0 ? void 0 : _c.disabled) !== null && _d !== void 0 ? _d : i.disabled, class: inputClass(i), onInput: function (e) {
                        var _a;
                        i.value = e.target.value;
                        if ((_a = i.attributes) === null || _a === void 0 ? void 0 : _a.onInput) {
                            i.attributes.onInput(e);
    ...
    Alert.prototype.render = function () {
        var _e;
        var _this = this;
        var _f = this, overlayIndex = _f.overlayIndex, header = _f.header, subHeader = _f.subHeader;
        var mode = getIonMode(this);
        ...
        return (h(Host, { role: "dialog", "aria-modal": "true", tabindex: "-1", style: {
            ...
            }, class: Object.assign(Object.assign({}, getClassMap(this.cssClass)), (_e = {}, _e[mode] = true, _e['alert-translucent'] = this.translucent, _e)), onIonAlertWillDismiss: this.dispatchCancelHandler, onIonBackdropTap: this.onBackdropTap }, h("ion-backdrop", { tappable: this.backdropDismiss }), h("div", { class: "alert-wrapper", ref: function (el) { return _this.wrapperEl = el; } }, h("div", { class: "alert-head" }, header && h("h2", { id: hdrId, class: "alert-title" }, header), subHeader && h("h2", { id: subHdrId, class: "alert-sub-title" }, subHeader)), h("div", { id: msgId, class: "alert-message", innerHTML: sanitizeDOMString(this.message) }), this.renderAlertInputs(labelledById), this.renderAlertButtons())));
    };
...
var buttonClass = function (button) {
    var _e;
    return Object.assign((_e = { 'alert-button': true, 'ion-focusable': true, 'ion-activatable': true }, _e["alert-button-role-" + button.role] = button.role !== undefined, _e), getClassMap(button.cssClass));
};
Alert.style = {
    /*STENCIL:MODE:ios*/ ios: alertIosCss,
    /*STENCIL:MODE:md*/ md: alertMdCss
};
