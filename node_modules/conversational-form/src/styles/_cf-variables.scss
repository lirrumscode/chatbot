...
$cf-color-background: #f4f4f4 !default;
$cf-color-primary: #303030 !default;
$cf-color-secondary: #f4f4f4 !default;
...
$cf-color-chat-response-default-text: darken($cf-color-secondary, 70%) !default;
...
/*
    Input
*/
$cf-color-input-text: darken($cf-color-secondary, 60%) !default;
