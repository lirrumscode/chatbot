    ...
    componentDidLoad() {
        {
            rIC(() => {
                ...
                if (config.getBoolean('statusTap', isHybrid)) {
                    import('./status-tap-171795fe.js').then(module => module.startStatusTap());
                }
                if (config.getBoolean('inputShims', needInputShims())) {
                    import('./input-shims-d4609e0d.js').then(module => module.startInputShims(config));
                }
                if (config.getBoolean('hardwareBackButton', isHybrid)) {
                    import('./hardware-back-button-7b6ede21.js').then(module => module.startHardwareBackButton());
                }
                if (typeof window !== 'undefined') {
                    import('./keyboard-a2b5e51d.js').then(module => module.startKeyboardAssist(window));
                }
