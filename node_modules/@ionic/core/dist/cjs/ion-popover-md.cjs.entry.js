...
class Popover {
    ...
    render() {
        ...
        return (index.h(index.Host, { "aria-modal": "true", "no-router": true, tabindex: "-1", style: {
            ...
            }, class: Object.assign(Object.assign({}, theme.getClassMap(this.cssClass)), { [mode]: true, 'popover-translucent': this.translucent }), onIonPopoverDidPresent: onLifecycle, onIonPopoverWillPresent: onLifecycle, onIonPopoverWillDismiss: onLifecycle, onIonPopoverDidDismiss: onLifecycle, onIonDismiss: this.onDismiss, onIonBackdropTap: this.onBackdropTap }, index.h("ion-backdrop", { tappable: this.backdropDismiss, visible: this.showBackdrop }), index.h("div", { class: "popover-wrapper" }, index.h("div", { class: "popover-arrow" }), index.h("div", { class: "popover-content" }))));
    }
