...
class Segment {
    ...
    async componentDidLoad() {
        ...
        this.gesture = (await Promise.resolve().then(function () { return require('./index-fdd5743d.js'); })).createGesture({
            el: this.el,
            gestureName: 'segment',
            gesturePriority: 100,
            threshold: 0,
...
class SegmentButton {
    ...
    render() {
        ...
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { "aria-disabled": disabled ? 'true' : null, class: {
                [mode]: true,
                ...
                'ion-focusable': true,
            } }, index.h("button", { type: type, "aria-pressed": checked ? 'true' : 'false', class: "button-native", part: "native", disabled: disabled }, index.h("span", { class: "button-inner" }, index.h("slot", null)), mode === 'md' && index.h("ion-ripple-effect", null)), index.h("div", { part: "indicator", class: {
